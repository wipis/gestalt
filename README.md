...
- **Research** - Studying how people interact with AI systems. What patterns emerge. What feels intuitive and what creates friction.
- **Design** - Designing interfaces and experiences for AI-first software. Focused on the interaction layer where humans and models meet.
- **Development** - Building web software that puts research and design into practice. Products, prototypes, and tools.
- **Consulting** - Helping teams build AI-first software with a focus on user experience and product design.
